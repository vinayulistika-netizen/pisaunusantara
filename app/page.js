        ...
        <div className="container">
          ...
          <div className="product-grid">
            {[
              ...
              { img: 'golok-kebun-tebas-bambu', alt: 'golok bersarung kayu ukir dengan gagang ukir kepala naga — PisauNusantara Bandung', name: 'Golok Kebun & Tebas Bambu', desc: 'Golok kebun serbaguna baja carbon untuk berkebun, menebas semak, dan tebas bambu. Bilah kuat tahan banting, gagang kayu keras, andalan petani dan pekebun.', badge: 'terlaris', waText: 'Golok%20Kebun%20%26%20Tebas%20Bambu' },
              { img: 'golok-sembelih-sapi', alt: 'golok sembelih sapi bersarung kayu ukir dengan gagang kayu — PisauNusantara Bandung', name: 'Golok Sembelih Sapi', desc: 'Golok sembelih sapi dan hewan kurban dengan bilah baja carbon sangat tajam. Panjang ideal untuk sapi dan kerbau, bilah rata sesuai syariat, kuat dan presisi.', badge: 'terlaris', waText: 'Golok%20Sembelih%20Sapi' },
              { img: 'golok-petok-cacah-tulang', alt: 'golok daging bilah lebar dengan gagang kayu dan sarung kayu, untuk cacah daging dan tulang — PisauNusantara Bandung', name: 'Golok Daging & Cacah Tulang', desc: 'Golok daging untuk cacah daging dan tulang, cocok untuk dapur maupun jagal. Bilah lebar dan berat, baja carbon tajam, mampu memotong tulang tanpa cepat tumpul.', badge: 'baru', waText: 'Golok%20Daging%20%26%20Cacah%20Tulang' },
              ...
              { img: 'gagang-golok-kayu', alt: 'gagang golok kayu keras melengkung dengan alur ukir, pengganti gagang golok — PisauNusantara Bandung', name: 'Gagang Golok Kayu', desc: 'Gagang golok dari kayu keras pilihan — kuat, awet, dan nyaman digenggam. Bisa dipesan untuk golok baru maupun penggantian gagang golok lama yang sudah rusak atau oblak. Pilihan jenis kayu, model polos maupun ukir tradisional.', badge: 'baru', waText: 'Gagang%20Golok%20Kayu' },
              { img: 'sarung-golok-kayu', alt: 'sarung golok kayu sarangka dengan bilah golok baja carbon — PisauNusantara Bandung', name: 'Sarung Golok Kayu', desc: 'Sarung golok (sarangka) dari kayu keras untuk melindungi bilah golok Anda. Bisa dipesan sesuai ukuran golok, tersedia pilihan polos maupun ukir tradisional.', badge: 'baru', waText: 'Sarung%20Golok%20Kayu' },
        ...
        <div className="container">
          <div className="contact-grid">
            <div className="contact-left">
              ...
              <span className="section-line" style={{margin:'12px 0 20px'}}></span>
              <p>Siap membantu Anda memilih perkakas kebun dan pisau outdoor terbaik. Tim kami aktif setiap hari kecuali Selasa, pukul 08.00–17.00 WIB.</p>
            ...
            <div className="contact-right">
              ...
              <div className="contact-item"><span className="c-icon">🕐</span><div><div className="c-label">Jam Operasional</div><div className="c-val">Setiap hari kecuali Selasa, 08.00–17.00 WIB</div></div></div>
